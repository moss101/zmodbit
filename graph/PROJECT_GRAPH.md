...
flowchart LR
  ...
  M1["M1<br/>Durable local shell and Core<br/>15/31 done"]
...
| M1 Durable local shell and Core | IN_PROGRESS | yes | 5 | 26 | 15 | 0 | M0 | user creates durable task, kills/restarts app/Core, same task recovers with no fake state. |
